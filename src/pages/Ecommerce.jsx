  ...
  return (
    <div className='mt-12'>
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repat bg-cover bg-center'>
          ...
          {earningData.map((item)=>(
            ...
            >
              <button
                ...
                className='text-2xl opacite-0.9 rounded-full p-4 hover:drop-shadow-xl'
              >
                {item.icon}
              </button>
              <p className='mt-3'>
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        ...
        dark:bg-text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780'>
